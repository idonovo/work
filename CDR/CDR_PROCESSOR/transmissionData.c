...
#define QUEUE_FILENAME  "home/student/work/CDR/"
#define QUEUE_ID 'f'
...
int ReadFromChannelWithWait(void* _context, size_t _size, ChannelData* _data)
{
	MessageBox messageBox;
	...
	if(FAIL == msgrcv(_data->m_channelID, &messageBox, BUFFER_SIZE, _data->m_type, 0))
	{
		/*LOG_WRITE(_data->m_logData, 5); */
		return -1;
	}
