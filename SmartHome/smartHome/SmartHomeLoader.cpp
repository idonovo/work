...
SmartHomeLoader::SmartHomeLoader(Hub* _hub, tr1::shared_ptr<LoggerManager> _loggerManager): loggerManager (_loggerManager), factory(new AgentFactory), parser(new Parser), hub(_hub)
{
