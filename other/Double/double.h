 ...
 * The Double Linked List is dynamicaly allocated and can grow and shrink on demand.
 * 
 * @author Author Sarig Namer (sarignamer@yahoo.com) 
*/
 ...
 *
 * @warning Will return 0 if _list is null or empty.
*/
